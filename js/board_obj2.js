...
function boardInit() {
  for (var i = 0; i < continents['valonguinho'].territories.length - 1; i++) {
  ...
  players[names[1]].territories.push(continents['valonguinho'].territories[continents['valonguinho'].territories.length - 1]);
  territories[continents['valonguinho'].territories[continents['valonguinho'].territories.length - 1]].troops = 2;
  territories[continents['valonguinho'].territories[continents['valonguinho'].territories.length - 1]].owner = names[1];
  target_territory = document.getElementsByClassName(continents['valonguinho'].territories[continents['valonguinho'].territories.length - 1])[0];
  target_territory.classList.add('taken-' + 1);
  updateTerritory(continents['valonguinho'].territories[continents['valonguinho'].territories.length - 1], tooltips[continents['valonguinho'].territories[continents['valonguinho'].territories.length - 1]]);
  ...
  for (var i = 0; i < continents['praia-vermelha'].territories.length; i++) {
    players[names[0]].territories.push(continents['praia-vermelha'].territories[i]);
    territories[continents['praia-vermelha'].territories[i]].troops = 2;
    territories[continents['praia-vermelha'].territories[i]].owner = names[0];
  ...
  for (var i = 0; i < continents['UCI'].territories.length; i++) {
    players[names[2]].territories.push(continents['UCI'].territories[i]);
    territories[continents['UCI'].territories[i]].troops = 2;
    territories[continents['UCI'].territories[i]].owner = names[2];
