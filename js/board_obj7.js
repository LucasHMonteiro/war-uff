...
function boardInit() {
  ...
  for (var i = 0; i < continents['gragoata'].territories.length; i++) {
    players[names[0]].territories.push(continents['gragoata'].territories[i]);
    territories[continents['gragoata'].territories[i]].troops = 2;
    territories[continents['gragoata'].territories[i]].owner = names[0];
