...
function boardInit() {
  ...
  players[names[1]].territories.push(continents['praia-vermelha'].territories[continents['praia-vermelha'].territories.length - 1]);
  territories[continents['praia-vermelha'].territories[continents['praia-vermelha'].territories.length - 1]].troops = 2;
  territories[continents['praia-vermelha'].territories[continents['praia-vermelha'].territories.length - 1]].owner = names[1];
  ...
  for (var i = 0; i < continents['UCI'].territories.length; i++) {
    players[names[0]].territories.push(continents['UCI'].territories[i]);
    territories[continents['UCI'].territories[i]].troops = 2;
    territories[continents['UCI'].territories[i]].owner = names[0];
