...
function boardInit() {
  for (var i = 0; i < continents['praia-vermelha'].territories.length - 2; i++) {
  ...
  players[names[2]].territories.push(continents['praia-vermelha'].territories[continents['praia-vermelha'].territories.length - 1]);
  territories[continents['praia-vermelha'].territories[continents['praia-vermelha'].territories.length - 1]].troops = 1;
  territories[continents['praia-vermelha'].territories[continents['praia-vermelha'].territories.length - 1]].owner = names[2];
  ...
  players[names[1]].territories.push(continents['praia-vermelha'].territories[continents['praia-vermelha'].territories.length - 2]);
  territories[continents['praia-vermelha'].territories[continents['praia-vermelha'].territories.length - 2]].troops = 2;
  territories[continents['praia-vermelha'].territories[continents['praia-vermelha'].territories.length - 2]].owner = names[1];
  target_territory = document.getElementsByClassName(continents['praia-vermelha'].territories[continents['praia-vermelha'].territories.length - 2])[0];
  target_territory.classList.add('taken-' + 1);
  updateTerritory(continents['praia-vermelha'].territories[continents['praia-vermelha'].territories.length - 2], tooltips[continents['praia-vermelha'].territories[continents['praia-vermelha'].territories.length - 2]]);
  for (var i = 0; i < continents['gragoata'].territories.length - 1; i++) {
  ...
  players[names[1]].territories.push(continents['gragoata'].territories[continents['gragoata'].territories.length - 1]);
  territories[continents['gragoata'].territories[continents['gragoata'].territories.length - 1]].troops = 2;
  territories[continents['gragoata'].territories[continents['gragoata'].territories.length - 1]].owner = names[1];
  target_territory = document.getElementsByClassName(continents['gragoata'].territories[continents['gragoata'].territories.length - 1])[0];
  target_territory.classList.add('taken-' + 1);
  updateTerritory(continents['gragoata'].territories[continents['gragoata'].territories.length - 1], tooltips[continents['gragoata'].territories[continents['gragoata'].territories.length - 1]]);
  for (var i = 0; i < continents['valonguinho'].territories.length; i++) {
    players[names[0]].territories.push(continents['valonguinho'].territories[i]);
    territories[continents['valonguinho'].territories[i]].troops = 2;
    territories[continents['valonguinho'].territories[i]].owner = names[0];
