...
function boardInit() {
  ...
  players[names[4]].territories.push(continents['praia-vermelha'].territories[continents['praia-vermelha'].territories.length - 1]);
  territories[continents['praia-vermelha'].territories[continents['praia-vermelha'].territories.length - 1]].troops = 2;
  territories[continents['praia-vermelha'].territories[continents['praia-vermelha'].territories.length - 1]].owner = names[4];
  ...
  target_territory.classList.add('taken-' + 4);
